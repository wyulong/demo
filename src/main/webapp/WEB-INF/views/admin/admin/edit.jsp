						...
						<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" name="department" value="${admin.department}" id="department"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" placeholder="请输入用户名" name="username" disabled="disabled" value="${admin.username}" id="username" class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" value="${admin.email}" name="email" id="email"
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<c:forEach var="role" items="${roles}">   
                                        ...
                                        <input type="checkbox" <c:if test="${role.selected}"> checked </c:if> name="roleIds" id="roleIds" value="${role.id}" id="inlineCheckbox1">${role.name }</label>
                                     </c:forEach>
                                </div>
                            </div>
							<div class="form-group">
								<label class="col-sm-2 control-label">是否启用:</label>
								 <div class="col-sm-4">
                                    <div class="checkbox i-checks">
                                        <label>
                                            <input type="checkbox" id="isEnabled" <c:if test="${admin.isEnabled}"> checked </c:if> name="isEnabled"><i></i></label>
                                    </div>
                                  </div>
							</div>
							<div class="hr-line-dashed"></div>
