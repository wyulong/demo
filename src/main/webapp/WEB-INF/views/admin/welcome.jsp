...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="${pageContext.request.contextPath}/static/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <p><i class="fa fa-send-o"></i> 博客：<a href="http://www.test.com/" target="_blank">http://www.test.com</a>
                        </p>
                        <p><i class="fa fa-qq"></i> QQ：<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=328956438&amp;site=qq&amp;menu=yes" target="_blank">328956438</a>
                        </p>
                        <p><i class="fa fa-weixin"></i> 微信：<a href="javascript:;">328956438</a>
                        </p>
                        <p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息">328956438@qq.com / *车</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <p id="pay-qrcode">
                            <a href="javascript:;"><img src="${pageContext.request.contextPath}/static/img/pay.png" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                            </a>
                        </p>
    ...
    <script src="${pageContext.request.contextPath}/static/js/welcome.min.js"></script>
</body>
</html>