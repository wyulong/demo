						...
						<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" name="name" id="name" value="${role.name}" disabled="disabled"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    	<label class="checkbox-inline i-checks">
                                        <input type="checkbox" name="authorities" <c:if test="${fn:contains(authories,'admin:user')}">checked </c:if> id="authorities" value="admin:user">用户管理</label>
                                        <label class="checkbox-inline i-checks">
                                        <input type="checkbox" name="authorities" <c:if test="${fn:contains(authories,'admin:news')}">checked </c:if> id="authorities" value="admin:news">新闻管理</label>
                                        <label class="checkbox-inline i-checks">
                                        <input type="checkbox" name="authorities" <c:if test="${fn:contains(authories,'admin:test')}">checked </c:if> id="authorities" value="admin:test">测试管理</label>
                                </div>
                            </div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
